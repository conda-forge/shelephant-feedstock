...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/shelephant-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11184&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/shelephant-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `shelephant` can be installed with:

```
conda install shelephant
```

It is possible to list all of the versions of `shelephant` available on your platform with:
